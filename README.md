...
- Light Host Modern by [Matheus Heidemann - heide-oficial](https://github.com/heide-oficial).
- Original [Light Host](https://github.com/opencma/LightHost) by Rolando Islas / OpenCMA.
